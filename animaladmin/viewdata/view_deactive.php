...
<div class="x_panel">
<div class="x_title">
<h2>View of History Account Member<small style="color: #6cb76e;">Online Animal Welfare.</small></h2>
...
if($row['state'] == "active"){
 ...
 echo "<a href=\"#\" style=\"text-align: center; color: white; background: #e93434;\"  onClick=\"cancel('".$row['postal_id']."')\"  class=\"btn-sm waves-effect btn-defaultts\" name=\"upade\">Inactive</a></center></td>";
   ...
   echo "<a href=\"#\" style=\"text-align: center; color: white; background: #6cb76e;\"  onClick=\"activate('".$row['user_id']."')\"  class=\"btn-sm waves-effect btn-defaultts\" name=\"upade\">Activate</a></center></td>";
