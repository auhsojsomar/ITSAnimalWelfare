...
<form action="" method="post">
  ...
  <input type="hidden" name="namess" value="<?php echo $pet_id; ?>">
<div class="col-md-12">
<div class="form-group">
<input type="text" disabled required class="form-control" disabled value="<?php echo $names_owner; ?>" id="field-1" placeholder="">
</div>
</div>
...
<input type="text" name="subject" required class="form-control" id="field-1" placeholder="">
</div>
</div>
</div>
    <div class="row">
...
$querys = "INSERT into compose(compose_id,to_user,from_user,subject,message) VALUES('','$to_user','$from_user','$subject','$message')";
