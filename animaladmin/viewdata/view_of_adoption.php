...
<div class="x_panel">
<div class="x_title">
<h2>Shelter<small style="color: #6cb76e;">Online Animal Welfare.</small></h2>
...
$username = $_SESSION['username'];                   
$query = mysqli_query($conn,"SELECT * from tbl_pets inner join user_tbl on tbl_pets.user = user_tbl.user_id inner join adoption on tbl_pets.pet_id = adoption.pets where tbl_pets.get_adopt = '1' and adoption.approved = '0'  and user_tbl.username = '$username'");
...
<td><center><a href="#" style="text-align: center; color: white; background: #e93434;" onClick="reject(<?php echo $row['pet_id']; ?>)"  class="btn-sm waves-effect btn-defaultts" name="upade">Reject</a>
<?php

if($row['approved'] == "0"){

  echo "<a href=\"#\" style=\"text-align: center; color: white; background: #6cb76e;\" onClick=\"approved('".$row['adopt_id']."')\"  class=\"btn-sm waves-effect btn-defaultts\" name=\"upade\">Approved</a></center></td>";

}elseif($row['approved'] == "1"){

 echo "<a href=\"#\" style=\"text-align: center; color: white; background: #e93434;\"  onClick=\"cancel('".$row['adopt_id']."')\"  class=\"btn-sm waves-effect btn-defaultts\" name=\"upade\">Cancel</a></center></td>";
}
...
window.location.href = 'reject.php?reject='+delid+'';
