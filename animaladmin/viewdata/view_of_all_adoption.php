...
$username = $_SESSION['username'];                   
$query = mysqli_query($conn,"SELECT * from tbl_pets inner join user_tbl on tbl_pets.user = user_tbl.user_id inner join adoption on tbl_pets.pet_id = adoption.pets where tbl_pets.get_adopt = '1'");
