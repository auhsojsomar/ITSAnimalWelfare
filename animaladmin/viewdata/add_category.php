...
<h4 class="modal-title" id="myModalLabel">Add Pet Category</h4>
</div>
...
<div class="x_panel">
<div class="x_title">
<h2>Pet Category<small style="color: #6cb76e;">Online Animal Welfare.</small></h2>
...
$query = mysqli_query($conn,"SELECT * from pet_category");
