...
<input type="text" name="title" required class="form-control" id="field-1" placeholder="">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
...
<div class="x_panel">
<div class="x_title">
<h2>View of Member<small style="color: #6cb76e;">bcc inc</small></h2>
...
$username = $_SESSION['username'];                   
$query = mysqli_query($conn,"SELECT * from user_level");

while ($row = mysqli_fetch_array($query)) {

?>
<tr>
<td><?php echo $row['title_userlevel']; ?></td>
<?php
...
$querys = "INSERT into user_level(userlvl_id,title_userlevel,statuss) VALUES('','$title','$statuss')";

$processs = mysqli_query($conn, $querys);

if ($processs) {
echo "<script>alert('Successfully added')</script>";
echo "<script>window.open('userlevel.php','_self')</script>";
}else{
