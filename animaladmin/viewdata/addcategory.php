...
$query = mysqli_query($conn,"SELECT * from pet_category  ORDER by date_created desc");
...
Bench Admin © 2017. All Rights Reserved <a href="https://colorlib.com"></a>
</div>
<div class="clearfix"></div>
</footer>
<!-- /footer content -->
...
function deleteCat(delid){

if (confirm("Are you sure you want to Delete this?")) {

window.location.href = 'delete_category.php?delete_category='+delid+'';
...
$querys = "INSERT into pet_category(petcat_id,catname,statuss) VALUES('','$catname','$statuss')";
