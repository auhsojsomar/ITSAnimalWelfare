...
<label for="field-1" class="control-label"><b>Attachment:</b></label>
...
<div class="col-md-12">
<div class="form-group">
<label for="field-1" class="control-label"><b>Description:</b></label>
...
<input type="submit" class="btn btn-primary" name="updates" style="background: #6cb76e; color: white; float: right; border-color: #6cb76e;" value="Send">
</div>
</form>
...
$sql = "INSERT into attachment(attach_id,attachment,user_id,description) VALUES('','$attachment','$userid','$description')";

$processs = mysqli_query($conn, $sql);

$sql = "UPDATE user_tbl SET proved = '1' where user_id = '$userid'";
