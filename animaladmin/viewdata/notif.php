...
<?php
   ...
   $query = "SELECT * from admin where username = '$admin_session'";
    ...
    ?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Suggest from customers <small style="color: red;">bench</small></h2>
        ...
        <footer>
          <div class="pull-right">
            Bcc Inc. © <script>document.write(new Date().getFullYear())</script>. All Rights Reserved <a href=""></a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
