                  ...
                  <div class="x_title">
                    ...
                    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search.." title="Type in a name">
                      ...
                      <?php
                         ...
                         $sql = mysqli_query($conn, "SELECT * from attachment inner join user_tbl on attachment.user_id = user_tbl.user_id where attachment.enabled = '1' and user_tbl.proved = '1'");
